...
def test_actions():
    ...
    print(f"cliff action count: {len(cliff_environment.actions)}") if verbose else None
    ...
    print(f"random_walk action count: {len(random_walk_environment.actions)}") if verbose else None
