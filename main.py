...
# comparison_type: common.ComparisonType = common.ComparisonType.MOUNTAIN_CAR_BATCH_SERIAL      # not good
# comparison_type: common.ComparisonType = common.ComparisonType.MOUNTAIN_CAR_BATCH_PARALLEL
