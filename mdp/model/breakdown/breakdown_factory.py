...
from mdp.model.breakdown.breakdown import Breakdown as BaseBreakdown
...
def breakdown_factory(comparison: common.Comparison) -> Optional[BaseBreakdown]:
    c = common.BreakdownType
    breakdown_type = comparison.breakdown_parameters.breakdown_type
    breakdown: Optional[breakdown.Breakdown]
